...
newH1.innerText = "test content, testing testing text";
...
var newTextNode = document.createTextNode("More test content for another h1, testing testing text");
...
function changeImageSrc() {
  ...
  image1.src = "img/designersdesk.png"
